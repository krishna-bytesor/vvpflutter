...
import '/components/password_updated/password_updated_widget.dart';
...
class _SetNewPasswordWidgetState extends State<SetNewPasswordWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SetNewPassword'});
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'SET_NEW_PASSWORD_Icon_xw3ftljv_ON_TAP');
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              '1qz4971s' /* Your new password must be diff... */,
                            ),
                            textAlign: TextAlign.center,
                          ...
                          Builder(
                            builder: (context) => InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SET_NEW_PASSWORD_Container_etye86is_ON_T');
                                if (_model.passwordTextController1.text ==
                                    _model.passwordTextController2.text) {
                                  logFirebaseEvent('Container_backend_call');
                                  _model.password = await LaravelGroup
                                      .forgotPasswordSetCall
                                      .call(
                                    email: widget.email,
                                    otp: widget.otp,
                                    password:
                                  ...
                                  if ((_model.password?.succeeded ?? true)) {
