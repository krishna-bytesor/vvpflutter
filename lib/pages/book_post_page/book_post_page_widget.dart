...
class _BookPostPageWidgetState extends State<BookPostPageWidget> {
  ...
  static const String s3BaseUrl =
      'https://vvpswamiv2.s3.ap-southeast-2.amazonaws.com';

  // Helper function to get full URL
  String getFullUrl(dynamic item, String field) {
    final relativePath = getJsonField(item, field)?.toString();
                    ...
                    Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'BOOK_POST_chevron_left_ICN_ON_TAP');
                            ...
                            onTap: () async {
                              ...
                              if (confirmDialogResponse) {
                                ...
                                await action_blocks.downloadFile(
                                  ...
                                  fileJson: {
                                    'data': getFullUrl(
                                        widget.bookItem, r'''$.image'''),
                                    'id': getJsonField(
                                        widget.bookItem, r'''$.id'''),
                                    'post_type_id': 2,
                                    'title': getJsonField(
                                            widget.bookItem, r'''$.title''') ??
                                        'Book',
                                  },
                                );
                                logFirebaseEvent('Icon_launch_u_r_l');
                                await launchURL(getFullUrl(
                                  widget.bookItem,
                                  r'''$.image''',
                                ));
                              }
