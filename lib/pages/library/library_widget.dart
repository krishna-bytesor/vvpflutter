                    ...
                    Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'LIBRARY_PAGE_chevron_left_ICN_ON_TAP');
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LIBRARY_PAGE_Row_ggldmytb_ON_TAP');
                                      logFirebaseEvent('Row_navigate_to');

                                      context.pushNamed(
                                          FavoriteListWidget.routeName);
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LIBRARY_PAGE_Row_u1i9rcoa_ON_TAP');
                                      logFirebaseEvent('Row_navigate_to');
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LIBRARY_PAGE_Row_225jumug_ON_TAP');
                                      logFirebaseEvent('Row_navigate_to');

                                      context
                                          .pushNamed(NotesListWidget.routeName);
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LIBRARY_PAGE_Row_vn0ofb2p_ON_TAP');
                                      logFirebaseEvent('Row_navigate_to');

                                      context
                                          .pushNamed(DownloadsWidget.routeName);
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
