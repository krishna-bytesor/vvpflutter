...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.notification = widget.notification!;
      safeSetState(() {});
    ...
    _model.meesageTextController ??= TextEditingController();
    _model.meesageFocusNode ??= FocusNode();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: SafeArea(
        child: Scaffold(
        key: scaffoldKey,
        body: StreamBuilder<ChatMessagesRecord>(
          stream: ChatMessagesRecord.getDocument(widget.chat!),
                    ...
                    Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHAT_PAGE_chevron_left_ICN_ON_TAP');
                      ...
                      child: Container(
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final messages = containerChatMessagesRecord
                                    .messages
                                    .toList();
                                if (messages.isEmpty) {
                        ...
                        children: [
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.meesageTextController,
                                    focusNode: _model.meesageFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    ...
                                    maxLines: null,
                                    validator: _model
                                        .meesageTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                          ...
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CHAT_PAGE_Icon_h4ebswfc_ON_TAP');
                                if (_model.meesageTextController.text != '') {
                                  // newChatMessage
                                  logFirebaseEvent('Icon_newChatMessage');

                                  await widget.chat!.update({
                                    ...createChatMessagesRecordData(
                                      notification: getJsonField(
                                        FFAppState().User,
                                        r'''$.is_swami''',
                                      )
                                          ? null
                                          : FFAppState().NotificationBool,
                                      swamiNotification: getJsonField(
                                        FFAppState().User,
                                        r'''$.is_swami''',
                                      )
                                          ? FFAppState().NotificationBool
                                    ...
                                    ...mapToFirestore(
                                      {
                                        'messages': FieldValue.arrayUnion([
                                          getChatMessagesFirestoreData(
                                            createChatMessagesStruct(
                                              message: _model
                                                  .meesageTextController.text,
                                              userId: getJsonField(
                                                FFAppState().User,
                                                r'''$.id''',
                                              ),
                                  ...
                                  if (_model.notification) {
                                    logFirebaseEvent(
                                        'Icon_trigger_push_notification');
                                    triggerPushNotification(
                                      notificationTitle: 'New Message',
                                      notificationText:
                                          _model.meesageTextController.text,
                                      userRefs: [widget.ref!],
                                  ...
                                  safeSetState(() {
                                    _model.meesageTextController?.clear();
                                  });
